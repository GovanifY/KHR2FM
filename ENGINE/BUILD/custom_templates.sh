...
num=`grep -n custom_package/debug=\"\" export.cfg | head -2 | tail -1 | awk -F: '{ print $1}'`; sed -i "${num},${num}s+custom_package/debug=\"\"+custom_package/debug=\"template.zip\"+" export.cfg
